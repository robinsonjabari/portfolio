          ...
          <div className='container mx-auto px-4'>
            ...
            <div className='max-w-3xl mx-auto text-base'>
              <p className='mb-4'>
                ...
                passion for web development and software engineering. My journey
                in tech began with the curiosity behind users interaction with
                technology and how code comes together to create interactive
                software. This evolved into a deep interest in creating
